...
--
ALTER TABLE `imagenes_campania`
  MODIFY `idImagenCampania` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `usuarios_registrados`
  MODIFY `idUsuarioRegistrado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `administradores`
  ADD CONSTRAINT `fk_administradores_usuarios_registrados1` FOREIGN KEY (`UsuariosRegistrados_Admin_idUsuarioRegistrado`) REFERENCES `usuarios_registrados` (`idUsuarioRegistrado`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `adopciones`
--
ALTER TABLE `adopciones`
  ADD CONSTRAINT `fk_adopciones_usuarios_registrados1` FOREIGN KEY (`UsuariosRegistrados_idUsuarioRegistrado`) REFERENCES `usuarios_registrados` (`idUsuarioRegistrado`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `arboles`
--
ALTER TABLE `arboles`
  ADD CONSTRAINT `fk_arboles_tipo_arbol1` FOREIGN KEY (`TiposArbol_idTipoArbol`) REFERENCES `tipos_arbol` (`idTipoArbol`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `campanias`
--
ALTER TABLE `campanias`
  ADD CONSTRAINT `fk_campanias_administradores1` FOREIGN KEY (`Administradores_idAdministrador`) REFERENCES `administradores` (`idAdministrador`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_campanias_tipos_campania1` FOREIGN KEY (`TiposCampania_idTipoCampania`) REFERENCES `tipos_campania` (`idTipoCampania`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `colonias`
--
ALTER TABLE `colonias`
  ADD CONSTRAINT `fk_colonias_ciudades1` FOREIGN KEY (`Ciudades_idCiudad`) REFERENCES `ciudades` (`idCiudad`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `comentarios`
--
ALTER TABLE `comentarios`
  ADD CONSTRAINT `fk_comentarios_tipos_comentario1` FOREIGN KEY (`TiposComentario_idTipoComentario`) REFERENCES `tipos_comentario` (`idTipoComentario`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_comentarios_usuarios1` FOREIGN KEY (`Usuarios_idUsuario`) REFERENCES `usuarios` (`idUsuario`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `det_adopciones`
--
ALTER TABLE `det_adopciones`
  ADD CONSTRAINT `fk_adopciones_has_arboles_adopciones1` FOREIGN KEY (`Adopciones_idAdopcion`) REFERENCES `adopciones` (`idAdopcion`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_adopciones_has_arboles_arboles1` FOREIGN KEY (`Arboles_idArbol`) REFERENCES `arboles` (`idArbol`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `det_temporadas`
--
ALTER TABLE `det_temporadas`
  ADD CONSTRAINT `fk_arboles_has_temporadas_arbol_arboles1` FOREIGN KEY (`Arboles_idArbol`) REFERENCES `arboles` (`idArbol`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_arboles_has_temporadas_arbol_temporadas_arbol1` FOREIGN KEY (`TemporadasArbol_idTemporadaArbol`) REFERENCES `temporadas_arbol` (`idTemporadaArbol`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `direcciones`
--
ALTER TABLE `direcciones`
  ADD CONSTRAINT `fk_direcciones_colonias1` FOREIGN KEY (`Colonias_idColonia`) REFERENCES `colonias` (`idColonia`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `donaciones`
--
ALTER TABLE `donaciones`
  ADD CONSTRAINT `fk_donaciones_usuarios1` FOREIGN KEY (`Usuarios_idUsuario`) REFERENCES `usuarios` (`idUsuario`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `faqs`
--
ALTER TABLE `faqs`
  ADD CONSTRAINT `fk_faqs_administradores1` FOREIGN KEY (`Administradores_idAdministrador`) REFERENCES `administradores` (`idAdministrador`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_faqs_secciones_faq1` FOREIGN KEY (`SeccionesFaq_idSeccionFaq`) REFERENCES `secciones_faq` (`idSeccionFaq`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `imagenes_campania`
--
ALTER TABLE `imagenes_campania`
  ADD CONSTRAINT `fk_imagenes_campania_campanias1` FOREIGN KEY (`Campanias_idCampania`) REFERENCES `campanias` (`idCampania`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `personas`
--
ALTER TABLE `personas`
  ADD CONSTRAINT `fk_personas_direcciones1` FOREIGN KEY (`Direcciones_idDireccion`) REFERENCES `direcciones` (`idDireccion`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_personas_usuarios_registrados1` FOREIGN KEY (`UsuariosRegistrados_Persona_idUsuarioRegistrado`) REFERENCES `usuarios_registrados` (`idUsuarioRegistrado`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `representantes`
--
ALTER TABLE `representantes`
  ADD CONSTRAINT `fk_representantes_personas1` FOREIGN KEY (`Personas_idPersona`) REFERENCES `personas` (`idPersona`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `telefonos`
--
ALTER TABLE `telefonos`
  ADD CONSTRAINT `fk_telefonos_usuarios_registrados1` FOREIGN KEY (`UsuariosRegistrados_Tel_idUsuarioRegistrado`) REFERENCES `usuarios_registrados` (`idUsuarioRegistrado`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuarios_registrados`
--
ALTER TABLE `usuarios_registrados`
  ADD CONSTRAINT `fk_usuarios_registrados_tipos_usuario1` FOREIGN KEY (`TiposUsuario_idTipoUsuario`) REFERENCES `tipos_usuario` (`idTipoUsuario`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usuarios_registrados_usuarios` FOREIGN KEY (`Usuarios_idUsuario`) REFERENCES `usuarios` (`idUsuario`) ON UPDATE CASCADE;
COMMIT;
