...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-08-2018 a las 12:31:52
...
(4, 'bf595-cactus.jpg', 'Cáctus', 'Cactugui', 'Estas curiosas plantas, originarias de américa y áfrica, están adaptadas soportar condiciones extremas de temperatura, luz y sequía.', 19, 'Activo', 1);
...
(1, 'jona.png', 'Jonathan Jair', 'Alfaro', 'Sánchez', 'jonathan_jair_01@hotmail.com', 'JOMIMAN Solutions', 'Jona', 0x3f6e85a22bfd8f16c120c8d4aa03cae8, 'Súper', 'Activo', 1, 2, 1),
(2, 'mary.png', 'Mary Carmne', 'Crecencio', 'Bernal', 'mary@hotmail.com', 'JOMIMAN Solution', 'Mary', 0x10573fc9e4c014b7bbf8b59ad6dfe346, 'Usuario general', 'Activo', 2, 3, 2),
(3, 'migue.png', 'Miguel Ángel', 'Mandujano', 'Barragán', 'migue@hotmail.com', 'JOMIMAN Solution', 'Migue', 0x75991fdbd8cdb5a3fbbae1aa218c1172, 'Usuario general', 'Activo', 3, 4, 5),
(4, 'gio.jpg', 'Giovanni Misael', 'Alfaro', 'Sánchez', 'gio@hotmail.com', 'JOMIMAN Solution', 'Gio', 0xe56e9f761272374251116e5bd9e46492, 'Usuario general', 'Activo', 4, 5, 2);
...
--
ALTER TABLE `adopciones`
  MODIFY `idAdopcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `det_adopciones`
  MODIFY `idDetAdopcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `det_temporadas`
--
ALTER TABLE `det_temporadas`
  MODIFY `idDetTemporada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
