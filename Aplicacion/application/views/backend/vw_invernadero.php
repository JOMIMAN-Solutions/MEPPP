<?php
/**
* Pagina de invernadero, del lado administrador
*
...
* Ultima modificacion el 29/07/2018 a las 01:39 pm
*/
?>
...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-12">
                <h3 class="text-themecolor">Invernadero</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><span class="text-themecolor">cPanel</span></li>
                    <li class="breadcrumb-item active">Invernadero</li>
