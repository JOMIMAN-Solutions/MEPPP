...
<div class="main" style="background-color: #b6d7a8">
    ...
    <div class="col-lg-10 col-xs-12 col-sm-10">
      <div class="row">
        <div class="col-lg-8 col-xs-12">
          <h1 style="color:#0b5c33;">Procuremos siempre que nuestros actos, deje una <strong>huella verde</strong> en nuestro camino.</h1>
        </div>
  ...
  <div class="row">
    ...
    <div class="col-lg-11 col-xs-12 col-sm-10 divContenidoR shadowL">
      ...
      <div class="row">
        <div class="col-lg-8 col-xs-12 col-md-12" style="background-color: white;margin-left: 10px">
          <div id='calendar'></div>
        </div>
            ...
            ?>
              <div class="item <?php if($cont==0){echo 'active';}?>" style="margin-top: 10px;">
                ...
                */
                ...
                ?>
                  <div class="col-lg-4 col-xs-12" >
                    <img src="<?=base_url().'images/usuarios/'.$socio->avatar;?>">
                  </div>
                  <?php
                      $cont++;
                    endforeach;
