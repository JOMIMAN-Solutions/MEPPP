...
* Ultima modificacion el 01/08/2018 a las 08:22 pm
*
...
/* -------------------------------------- BACKEND --------------------------------------- */
    ...
    public function cPanel()
    {
        ...
        // Perzonalizado
        $crud->fields('imagenPortada', 'nombreCampania', 'fechaInicio', 'fechaFin', 'hora', 'lugar', 'publico', 'estatusCampania', 'Usuarios_idUsuario', 'TiposCampania_idTipoCampania');
